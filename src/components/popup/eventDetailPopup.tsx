...
import { EventDetailSectionDetail } from '../../components/popup/eventDetailSectionDetail';
import { EventDetailSectionHeader } from '../../components/popup/eventDetailSectionHeader';
import { Template } from '../../components/template';
import { DetailPopupArrowDirection, HALF_OF_POPUP_ARROW_HEIGHT } from '../../constants/popup';
import { useDispatch, useStore } from '../../contexts/calendarStore';
import { useEventBus } from '../../contexts/eventBus';
import { useFloatingLayer } from '../../contexts/floatingLayer';
import { useLayoutContainer } from '../../contexts/layoutContainer';
import { cls } from '../../helpers/css';
import { isLeftOutOfLayout, isTopOutOfLayout } from '../../helpers/popup';
import { useCalendarColor } from '../../hooks/calendar/useCalendarColor';
import { optionsSelector } from '../../selectors';
import { eventDetailPopupParamSelector } from '../../selectors/popup';
import TZDate from '../../time/date';
import { isNil } from '../../utils/type';

import type { StyleProp } from '../../types/components/common';
import type { Rect } from '../../types/store';
